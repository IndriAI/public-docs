# Indri Services Agreement

This service agreement applies to current paying customers of the Indri platform. Indri, inc. will use commercially reasonable efforts to maintain uptime for its platform web services and web applications. Issues reported to services@indri.ai will receive a response within 24 hours. Responses will include a status update and, when applicable, plan for resolution for verified cases of services or web applications that are not responsive or not performing as specified by Indri’s product documentation.
